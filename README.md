...
**Live:** [flowstep-challenge.vercel.app](https://flowstep-challenge.vercel.app)
...
**[Open Tuck In](https://flowstep-challenge.vercel.app)**
...
1. Open [Tuck In](https://flowstep-challenge.vercel.app).
...
```bash
git clone https://github.com/dmustapha/flowstep-challenge.git
cd flowstep-challenge
npm install
npm run dev
```
